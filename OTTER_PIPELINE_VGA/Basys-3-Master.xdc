...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports {BUTTONS[4]}]				#C		
#	set_property IOSTANDARD LVCMOS33 [get_ports {BUTTONS[4]}]
#set_property PACKAGE_PIN T18 [get_ports {BUTTONS[3]}]			    #U
...
#set_property PACKAGE_PIN T17 [get_ports {BUTTONS[1]}]				#R
#	set_property IOSTANDARD LVCMOS33 [get_ports {BUTTONS[1]}]
#set_property PACKAGE_PIN U17 [get_ports {BUTTONS[0]}]				#D	
